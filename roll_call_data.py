...
value_counts = voter_data['legislator'].value_counts().rename_axis('legislator').reset_index(name = 'counts')
...
fvd_0['legislator_id'] = [voter_dictionary[legislator] for legislator in fvd_0['legislator']]
